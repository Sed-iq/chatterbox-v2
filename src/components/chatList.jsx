...
const genConfirm = (toast, newLink) => {
  ...
  textField.innerText = `This is my chat link generated from chatterbox v2, https://chatterbox-v2-api.vercel.app/anon/${newLink} (You don't have to login to use it)`;
